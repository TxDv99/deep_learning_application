...
class Trainer:
    ...
    def fine_tune(self, layers_to_unfreeze, data_split, batch_size, num_epochs,iter_time = None, early_stopping = 5, val_check = 3, checks = True, use_wandb = True, project_name = None):
        ...
        self.train(data_split, batch_size, num_epochs,iter_time, early_stopping , val_check , checks , use_wandb, project_name)
